 ...
 * A registration's object is responsible to capture additional data, not provided by Mahara, but required by registration's process.
 * See course_registation for an concrete example.
 *
